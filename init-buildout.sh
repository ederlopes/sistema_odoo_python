...
sudo apt-get -y install python3 python3-dev python3-pip mercurial \
 python3-psycopg2 libpq-dev build-essential autoconf libtool pkg-config \
 python3-opengl python-imaging python-pyrex python-pyside.qtopengl \
